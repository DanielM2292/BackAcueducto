...
INSERT INTO `auditoria` VALUES ('AUDI0001','administradores','ADMI0006','INSERT','ADMI0003','2024-12-26 23:22:25','Se crea usuario por primera vez'),('AUDI0002','administradores','ADMI0007','INSERT','ADMI0003','2024-12-27 20:52:07','Se crea usuario por primera vez'),('AUDI0003','administradores','ADMI0008','INSERT','ADMI0003','2024-12-30 22:14:51','Se crea usuario por primera vez'),('AUDI0004','administradores','ADMI0009','INSERT','ADMI0003','2024-12-30 22:18:42','Se crea usuario por primera vez'),('AUDI0005','administradores','ADMI0010','INSERT','ADMI0003','2024-12-30 22:20:15','Se crea usuario por primera vez'),('AUDI0006','administradores','ADMI0011','INSERT','ADMI0003','2024-12-30 22:40:38','Se crea usuario por primera vez');
...
CREATE TABLE `clientes` (
  ...
  `id_direccion` varchar(10) DEFAULT NULL,
...
INSERT INTO `clientes` VALUES ('CLI0001','CC','1092347021','Luis Carlos Zapata','31234','DIRE0001','ESTCLI001','MATR0001');
...
INSERT INTO `estado_matriculas` VALUES ('1','Parcial'),('2','Total');
...
CREATE TABLE `facturas` (
  ...
  CONSTRAINT `facturas_ibfk_3` FOREIGN KEY (`id_tarifa_estandar`) REFERENCES `tarifas_estandar` (`id_tarifa_estandar`),
  CONSTRAINT `facturas_ibfk_4` FOREIGN KEY (`id_tarifa_medidor`) REFERENCES `tarifa_medidores` (`id_tarifa_medidor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `matriculas` (
  ...
  CONSTRAINT `matriculas_ibfk_1` FOREIGN KEY (`id_matricula`) REFERENCES `estado_matriculas` (`id_estado_matricula`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `matriculas` VALUES ('MATR0001',40001,20000,'ESTMAT0002',NULL);
...
-- Dump completed on 2025-01-04 23:10:47
